...
public class ForgotPasswordModel {
	...
	/** The Forgot Password CTA */
	@ChildResource
	private Resource forgotPasswordCta;
	...
	public Resource getForgotPasswordCta() {
		return forgotPasswordCta;
	}

	public void setForgotPasswordCta(Resource forgotPasswordCta) {
		this.forgotPasswordCta = forgotPasswordCta;
	}
